...
public class CategoryAPIController {
    ...
    public ResponseEntity<?> addCategory(
        ...
        if (optCategory.isPresent()) {
            return new ResponseEntity<>(new Response(false, "Category đã tồn tại trong hệ thống", null),
    ...
    public ResponseEntity<?> updateCategory(
        ...
        if (optCategory.isEmpty()) {
            return new ResponseEntity<>(new Response(false, "Không tìm thấy Category", null),
                    HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<?> deleteCategory(@Validated @RequestParam("categoryId") Long categoryId) {
        ...
        try {
            ...
            return new ResponseEntity<>(
                    new Response(false, "Không thể xóa Category này vì vẫn còn Product liên kết. Vui lòng xóa hết Product thuộc Category này trước.", null),
                    HttpStatus.BAD_REQUEST);
        }
